...
public class techs extends JFrame implements ActionListener
{
	...
	public techs()
	{
		...
		ImageIcon id1 = new ImageIcon("image/tech/"+tp+".JPEG");
		...
		tupdate = new JButton("Update", new ImageIcon("image/other/update.gif"));
 		tupdate.setForeground(Color.white); 
		tupdate.setBackground(new Color(128,0,0));
		
			
		
		
		tupdate.setToolTipText("Update the record");	
			
			 
		tupdate.setBounds(450,480,105,30);
		...
		tupdate.addActionListener(this);
			...
			try
			{
				...
				t=0;
				ResultSet rs = stm.executeQuery("select * from tech where sid="+tp);
				while(rs.next())
				{	
					t=1;
					...
					ex.setText(rs.getString("exp"));
					ex1.setText(rs.getString("exp1"));
	...
	{	
		...
		if(source==tupdate)
		{
			...
			{	ResultSet rs1 = stm.executeQuery("select * from tech where sid="+id.getText());
					while(rs1.next())
					{	
						t=1;
					}
					if(t==1)
					{
						...
						//if(((id.getText()).length()!=0)&&(((name.getText()).length()!=0)||((fn.getText()).length()!=0)||((cj.getText()).length()!=0)||((dob.getText()).length()!=0)||((ad.getText()).length()!=0)||((phno.getText()).length()!=0)||((qu.getText()).length()!=0)||((as.getText()).length()!=0)||((padd.getText()).length()!=0)||((eadd.getText()).length()!=0)))
						{
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set name=? where sid="+id.getText());	
								ps.setString(1,name.getText());	ps.executeUpdate();
							}
							if((fn.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set fname=? where sid="+id.getText());	
								ps.setString(1,fn.getText());ps.executeUpdate();
							}
							if((do1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set do1=? where sid="+id.getText());	
								ps.setString(1,do1.getText());ps.executeUpdate();
							}
							
							if((do2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set do2=? where sid="+id.getText());	
								ps.setString(1,do2.getText());ps.executeUpdate();
							}
							
							if((do3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set do3=? where sid="+id.getText());	
								ps.setString(1,do3.getText());ps.executeUpdate();
							}
							
							if((ad1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set ad1=? where sid="+id.getText());	
								ps.setString(1,ad1.getText());ps.executeUpdate();
							}
							
							if((ad2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set ad2=? where sid="+id.getText());	
								ps.setString(1,ad2.getText());ps.executeUpdate();
							}
							
							if((ad3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set ad3=? where sid="+id.getText());	
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set job=? where sid="+id.getText());	
								ps.setString(1,jo1.getText());ps.executeUpdate();
							}
							if((d1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set dep=? where sid="+id.getText());	
								ps.setString(1,d1.getText());ps.executeUpdate();
							}
							if((ex.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set exp=? where sid="+id.getText());	
								ps.setString(1,ex.getText());ps.executeUpdate();
							}
							if((ex1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set exp1=? where sid="+id.getText());	
								ps.setString(1,ex1.getText());ps.executeUpdate();
							}
							if((q1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set qual=? where sid="+id.getText());	
								ps.setString(1,q1.getText());ps.executeUpdate();
							}
							if((ge1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set gen=? where sid="+id.getText());	
								ps.setString(1,ge1.getText());ps.executeUpdate();
							}
							if((as1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set sal=? where sid="+id.getText());	
								ps.setString(1,as1.getText());ps.executeUpdate();
							}
							
							if((phno.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set phno=? where sid="+id.getText());	
								ps.setString(1,phno.getText());ps.executeUpdate();
							}
							if((padd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set padd=? where sid="+id.getText());	
								ps.setString(1,padd.getText());ps.executeUpdate();
							}
							if((eadd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set eadd=? where sid="+id.getText());	
								ps.setString(1,eadd.getText());ps.executeUpdate();
							}
							if((rat1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update tech set rat=? where sid="+id.getText());	
								ps.setString(1,rat1.getText());ps.executeUpdate();
							}
