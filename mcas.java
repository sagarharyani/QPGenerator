...
public class mcas extends JFrame implements ActionListener
{
	...
	public mcas()
	{
		...
		cj1.setBackground(Color.white);
        	...
        	cupdate = new JButton("Update", new ImageIcon("image/other/update.gif"));
 		cupdate.setForeground(Color.black); 
		cupdate.setBackground(Color.gray);
		
			
		
		
		cupdate.setToolTipText("Update the record");	
		...
		c.add(home);
			...
			lp5.setBounds(630,390,150,20);
			lp6.setBounds(670,390,150,20);
			...
			p5.setBounds(630,410,30,20);
			p6.setBounds(670,410,30,20);
		...
		cupdate.setBounds(450,480,105,30);
		...
		ImageIcon id1 = new ImageIcon("image/mca/"+tp+".JPEG");
		...
		c.add(idd1);
			...
			try
			{
				...
				t=0;
				ResultSet rs = stm.executeQuery("select * from mca where sid="+tp);
				while(rs.next())
				{	
					t=1;
					...
					p5.setText(rs.getString("p5"));
			    		p6.setText(rs.getString("p6"));
	...
	{	
		...
		if(source==cupdate)
		{
			try
			{
				...
				t=0;
				if((Integer.parseInt(yr1.getText())>3)||(Integer.parseInt(yr1.getText())<1))
				jp.showMessageDialog(this,"Year Range Between 1-3 Years","INFORMATION",jp.ERROR_MESSAGE);
			else
			{
				...
				else
				{
					...
					if(t==1)
					{
						...
						//if(((id.getText()).length()!=0)&&(((name.getText()).length()!=0)||((fn.getText()).length()!=0)||((cj.getText()).length()!=0)||((dob.getText()).length()!=0)||((ad.getText()).length()!=0)||((phno.getText()).length()!=0)||((qu.getText()).length()!=0)||((as.getText()).length()!=0)||((padd.getText()).length()!=0)||((eadd.getText()).length()!=0)))
						{
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set name=? where sid="+id.getText());	
								ps.setString(1,name.getText());	ps.executeUpdate();
							}
							if((fn.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set fname=? where sid="+id.getText());	
								ps.setString(1,fn.getText());ps.executeUpdate();
							}
							if((do1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set do1=? where sid="+id.getText());	
								ps.setString(1,do1.getText());ps.executeUpdate();
							}
							
							if((do2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set do2=? where sid="+id.getText());	
								ps.setString(1,do2.getText());ps.executeUpdate();
							}
							
							if((do3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set do3=? where sid="+id.getText());	
								ps.setString(1,do3.getText());ps.executeUpdate();
							}
							
							if((ad1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set ad1=? where sid="+id.getText());	
								ps.setString(1,ad1.getText());ps.executeUpdate();
							}
							
							if((ad2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set ad2=? where sid="+id.getText());	
								ps.setString(1,ad2.getText());ps.executeUpdate();
							}
							
							if((ad3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set ad3=? where sid="+id.getText());	
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set al1=? where sid="+id.getText());	
								ps.setString(1,al1.getText());ps.executeUpdate();
							}
							if((al2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set al2=? where sid="+id.getText());	
								ps.setString(1,al2.getText());ps.executeUpdate();
							}if((al3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set al3=? where sid="+id.getText());	
								ps.setString(1,al3.getText());ps.executeUpdate();
							}
							if((as.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set ad=? where sid="+id.getText());	
								ps.setString(1,as.getText());ps.executeUpdate();
							}
							if((cj.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set cou=? where sid="+id.getText());	
								ps.setString(1,cj.getText());ps.executeUpdate();
							}
							if((qu.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set join=? where sid="+id.getText());	
								ps.setString(1,qu.getText());ps.executeUpdate();
							}
							if((ge.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set gen=? where sid="+id.getText());	
								ps.setString(1,ge.getText());ps.executeUpdate();
							}
							if((yr1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set year=? where sid="+id.getText());	
								ps.setString(1,yr1.getText());ps.executeUpdate();
							}
							if((phno.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set phno=? where sid="+id.getText());	
								ps.setString(1,phno.getText());ps.executeUpdate();
							}
							if((padd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set padd=? where sid="+id.getText());	
								ps.setString(1,padd.getText());ps.executeUpdate();
							}
							if((eadd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set eadd=? where sid="+id.getText());	
								ps.setString(1,eadd.getText());ps.executeUpdate();
							}
							if((pp1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set pp1=? where sid="+id.getText());	
								ps.setString(1,pp1.getText());ps.executeUpdate();
							}
							if((pp2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set pp2=? where sid="+id.getText());	
								ps.setString(1,pp2.getText());ps.executeUpdate();
							}
							if((pp3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set pp3=? where sid="+id.getText());	
								ps.setString(1,pp3.getText());ps.executeUpdate();
							}
							if((p1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p1=? where sid="+id.getText());	
								ps.setString(1,p1.getText());ps.executeUpdate();
							}
							if((p2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p2=? where sid="+id.getText());	
								ps.setString(1,p2.getText());ps.executeUpdate();
							}
							if((p3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p3=? where sid="+id.getText());	
								ps.setString(1,p3.getText());ps.executeUpdate();
							}
							if((p4.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p4=? where sid="+id.getText());	
								ps.setString(1,p4.getText());ps.executeUpdate();
							}
							if((p5.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p5=? where sid="+id.getText());	
								ps.setString(1,p5.getText());ps.executeUpdate();
							}
							if((p6.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update mca set p6=? where sid="+id.getText());	
								ps.setString(1,p6.getText());ps.executeUpdate();
							}
