...
public class btechs extends JFrame implements ActionListener
{
	...
	public btechs()
	{
		...
		{
			ImageIcon id1 = new ImageIcon("image/btech/"+tp+".JPEG");
		...
		cj1.setBackground(Color.white);
        	...
        	update = new JButton("Update", new ImageIcon("image/other/update.gif"));
		...
		update.setToolTipText("Update the record");	
			...
			llp.setBounds(400,410,150,20);
			llp1.setBounds(470,390,150,20);
			llp2.setBounds(510,390,150,20);
			llp3.setBounds(550,390,150,20);
			llp4.setBounds(590,390,150,20);
			llp5.setBounds(630,390,150,20);
			llp6.setBounds(670,390,150,20);
			llp7.setBounds(710,390,150,20);
		...
		update.setBounds(450,480,105,30);
		...
		c.add(home);
			...
			try
			{
				...
				t=0;
				ResultSet rs = stm.executeQuery("select * from btech where sid="+tp);
				while(rs.next())
				{	
					t=1;	
	...
	{	
		...
		if(source==update)
		{
			try
			{
				...
				t=0;
				if((Integer.parseInt(yr1.getText())>4)||(Integer.parseInt(yr1.getText())<1))
				jp.showMessageDialog(this,"Year Range Between 1-4 Years","INFORMATION",jp.ERROR_MESSAGE);
			else
			{
				...
				else
				{
					...
					if(t==1)
					{
						...
						//if(((id.getText()).length()!=0)&&(((name.getText()).length()!=0)||((fn.getText()).length()!=0)||((cj.getText()).length()!=0)||((dob.getText()).length()!=0)||((ad.getText()).length()!=0)||((phno.getText()).length()!=0)||((qu.getText()).length()!=0)||((as.getText()).length()!=0)||((padd.getText()).length()!=0)||((eadd.getText()).length()!=0)))
						{
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set name=? where sid="+id.getText());	
								ps.setString(1,name.getText());	ps.executeUpdate();
							}
							if((fn.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set fname=? where sid="+id.getText());	
								ps.setString(1,fn.getText());ps.executeUpdate();
							}
							if((do1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set do1=? where sid="+id.getText());	
								ps.setString(1,do1.getText());ps.executeUpdate();
							}
							
							if((do2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set do2=? where sid="+id.getText());	
								ps.setString(1,do2.getText());ps.executeUpdate();
							}
							
							if((do3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set do3=? where sid="+id.getText());	
								ps.setString(1,do3.getText());ps.executeUpdate();
							}
							
							if((ad1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set ad1=? where sid="+id.getText());	
								ps.setString(1,ad1.getText());ps.executeUpdate();
							}
							
							if((ad2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set ad2=? where sid="+id.getText());	
								ps.setString(1,ad2.getText());ps.executeUpdate();
							}
							
							if((ad3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set ad3=? where sid="+id.getText());	
							...
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set al1=? where sid="+id.getText());	
								ps.setString(1,al1.getText());ps.executeUpdate();
							}
							if((al2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set al2=? where sid="+id.getText());	
								ps.setString(1,al2.getText());ps.executeUpdate();
							}if((al3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set al3=? where sid="+id.getText());	
								ps.setString(1,al3.getText());ps.executeUpdate();
							}
							if((as.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set ad=? where sid="+id.getText());	
								ps.setString(1,as.getText());ps.executeUpdate();
							}
							if((cj.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set cou=? where sid="+id.getText());	
								ps.setString(1,cj.getText());ps.executeUpdate();
							}
							if((qu.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set join=? where sid="+id.getText());	
								ps.setString(1,qu.getText());ps.executeUpdate();
							}
							if((ge.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set gen=? where sid="+id.getText());	
								ps.setString(1,ge.getText());ps.executeUpdate();
							}
							if((yr1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set year=? where sid="+id.getText());	
								ps.setString(1,yr1.getText());ps.executeUpdate();
							}
							if((phno.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set phno=? where sid="+id.getText());	
								ps.setString(1,phno.getText());ps.executeUpdate();
							}
							if((padd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set padd=? where sid="+id.getText());	
								ps.setString(1,padd.getText());ps.executeUpdate();
							}
							if((eadd.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set eadd=? where sid="+id.getText());	
								ps.setString(1,eadd.getText());ps.executeUpdate();
							}
							if((pp1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set pp1=? where sid="+id.getText());	
								ps.setString(1,pp1.getText());ps.executeUpdate();
							}
							if((pp2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set pp2=? where sid="+id.getText());	
								ps.setString(1,pp2.getText());ps.executeUpdate();
							}
							if((p1.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p1=? where sid="+id.getText());	
								ps.setString(1,p1.getText());ps.executeUpdate();
							}
							if((p2.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p2=? where sid="+id.getText());	
								ps.setString(1,p2.getText());ps.executeUpdate();
							}
							if((p3.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p3=? where sid="+id.getText());	
								ps.setString(1,p3.getText());ps.executeUpdate();
							}
							if((p4.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p4=? where sid="+id.getText());	
								ps.setString(1,p4.getText());ps.executeUpdate();
							}
							if((p5.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p5=? where sid="+id.getText());	
								ps.setString(1,p5.getText());ps.executeUpdate();
							}
							if((p6.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p6=? where sid="+id.getText());	
								ps.setString(1,p6.getText());ps.executeUpdate();
							}
							if((p7.getText()).length()!=0)
							{
								PreparedStatement ps=c.prepareStatement ("Update btech set p7=? where sid="+id.getText());	
								ps.setString(1,p7.getText());ps.executeUpdate();
							}
