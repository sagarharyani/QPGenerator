	...
	{	
		...
		if(str1.equals("Submit"))
		{
			try
			{
				...
				PreparedStatement ps2  = c.prepareStatement("create table pd(id varchar(10),pa varchar(10))");
				ps2.executeUpdate();
				PreparedStatement ps3  = c.prepareStatement("insert into pd values(?,?)");
		        	ps3.setString(1,uname.getText());
				ps3.setString(2,npd.getText());
				ps3.executeUpdate();
				PreparedStatement ps4  = c.prepareStatement("create table btech(sid varchar(10),name varchar(20),fname varchar(20),do1 varchar(10),do2 varchar(10),do3 varchar(10),ad1 varchar(10),ad2 varchar(10),ad3 varchar(10),al1 varchar(10),al2 varchar(10),al3 varchar(10),ad varchar(20),cou varchar(10),join varchar(10),gen varchar(10),year varchar(10),phno varchar(20),padd varchar(30),eadd varchar(30),pp1 varchar(10),pp2 varchar(20),p1 varchar(10),p2 varchar(10),p3 varchar(10),p4 varchar(10),p5 varchar(10),p6 varchar(10),p7 varchar(10))");
				ps4.executeUpdate();
				PreparedStatement ps5  = c.prepareStatement("create table mca(sid varchar(10),name varchar(20),fname varchar(20),do1 varchar(10),do2 varchar(10),do3 varchar(10),ad1 varchar(10),ad2 varchar(10),ad3 varchar(10),al1 varchar(10),al2 varchar(10),al3 varchar(10),ad varchar(20),cou varchar(10),join varchar(10),gen varchar(10),year varchar(10),phno varchar(20),padd varchar(30),eadd varchar(30),pp1 varchar(10),pp2 varchar(20),pp3 varchar(10),p1 varchar(10),p2 varchar(10),p3 varchar(10),p4 varchar(10),p5 varchar(10),p6 varchar(10))");
				ps5.executeUpdate();
