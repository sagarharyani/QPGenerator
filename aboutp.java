...
public class aboutp extends JFrame implements ActionListener
{
	...
	public aboutp()
	{
		...
		setCursor(cur);
			...
			ImageIcon hl = new ImageIcon("image/other/helpLib.gif");
			JLabel logoCD = new JLabel(hl);
			c.add(logoCD);  
			logoCD.setBounds(0,0,720,580);
	...
	public void n13()
 	{
		 ...
		 aboutp u1=new aboutp();
		u1.setResizable(false);
		u1.setBounds(0,0,720,580);
		u1.show();
	 }
}	