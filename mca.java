...
public class mca extends JFrame implements ActionListener
{
	...
	public mca()
	{
		...
		new1.setBackground(Color.gray);
        	csave = new JButton("Save", new ImageIcon("image/other/Save.gif")); 
		csave.setForeground(Color.black); 
		csave.setBackground(Color.gray);
		...
		csave.setToolTipText("Save the record");	
			...
			lp.setBounds(400,350,150,20);
			lp1.setBounds(470,330,150,20);
			lp2.setBounds(510,330,150,20);
			lp3.setBounds(550,330,150,20);
			lp4.setBounds(590,330,150,20);
			lp5.setBounds(630,330,150,20);
			lp6.setBounds(670,330,150,20);
			
			lpp.setBounds(400,300,150,20);
			lpp1.setBounds(540,280,150,20);
			lpp2.setBounds(580,280,150,20);
			lpp3.setBounds(620,280,150,20);
			...
			pp3.setBounds(620,300,30,20);
			
			
		
		new1.setBounds(450,450,100,30);
		csave.setBounds(560,450,100,30);
		...
		lqul = new Choice();
		lqul.add("ICET");lqul.add("Managment");
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					{
						t=0;
						PreparedStatement ps  = c.prepareStatement("insert into mca values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						ps.setString(23,pp3.getText());
						else
						ps.setString(23,"");
						if((p1.getText()).length()!=0)
						ps.setString(24,p1.getText());
						else
						ps.setString(24,"");
						if((p2.getText()).length()!=0)
						ps.setString(25,p2.getText());
						else
						ps.setString(25,"");
						if((p3.getText()).length()!=0)
						ps.setString(26,p3.getText());
						else
						ps.setString(26,"");
						if((p4.getText()).length()!=0)
						ps.setString(27,p4.getText());
						else
						ps.setString(27,"");
						if((p5.getText()).length()!=0)
						ps.setString(28,p5.getText());
						else
						ps.setString(28,"");
						if((p6.getText()).length()!=0)
						ps.setString(29,p6.getText());
						else
						ps.setString(29,"");
